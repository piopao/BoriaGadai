...
public class UserAccountManagerTest {
	...
	public static void setUpDB() throws Exception {
		...
		dataSource
				.setURL("jdbc:mysql://localhost:3306/db?characterEncoding=UTF-8");
	...
	public void CreateUserAccountTest() {
		...
		assertEquals(testUser.getHashedPassword(),
				checkTestUser.getHashedPassword());
	...
	public void testChanges() {
		User dummy = new User("dummy", "dummy", "dummson", "dummy@hash",
				"dummy@mail.com", null, "Female", null, "i am dummy");
		manager.createUserAccount(dummy);
		...
		assertEquals(temp.getHashedPassword(),
				hsh.generate_hash("testpassword"));
